...
const deals = [
  ...
  },
  {
    ...
    body: "Order meals, add delivery, and checkout through Paystack with Fast Fleets 360 handling movement.",
  ...
  },
  {
    ...
    body: "Register, complete KYC, and get reviewed by Fast Fleets 360 operations before going live.",
