...
export const metadata: Metadata = {
  ...
  description: "Fast Fleets 360 Logistics privacy policy for account data, location data, payments, rider KYC, retention, user rights, cookies, and NDPR compliance."
};
...
const sections = [
  ...
  {
    title: "5. User rights",
    body: "Under the Nigeria Data Protection Act 2023 and applicable NDPR/NDPC guidance, you may request access, correction, export, deletion, objection, restriction of processing, withdrawal of consent where processing relies on consent, and information about automated processing. You may also lodge a complaint with the Nigeria Data Protection Commission. You can update profile details inside the dashboard, use the in-app Delete my account control, or contact Fast Fleets 360 for a data request. We may ask for identity verification before actioning sensitive requests."
  },
  {
    title: "6. Cookies and local storage",
    body: "Fast Fleets 360 uses cookies and local storage to keep users signed in, remember preferences, support PWA offline behaviour, store non-sensitive draft booking data, improve performance, and protect sessions. You can clear browser storage, but some app features may stop working until you sign in again."
  },
  {
    title: "7. Security",
  ...
  {
    title: "8. Children",
    body: "Fast Fleets 360 is intended for users who are at least 18 years old. We do not knowingly onboard children as customers, riders, business operators, or team members."
  },
  {
...
export default function PrivacyPage() {
  return (
    <section className="section-wrap py-10">
      ...
      <h1 className="mt-3 max-w-3xl text-4xl font-black leading-tight text-fleet-night sm:text-6xl">How Fast Fleets 360 handles user data.</h1>
