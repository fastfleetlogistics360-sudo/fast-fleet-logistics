  ...
  return (
    <section className="section-wrap py-10">
      ...
      <div className="mt-8 grid gap-5 text-sm font-semibold leading-7 text-slate-600">
        ...
        <p>When live services are enabled, Supabase may store authentication/session details and Squad may process payment references needed to verify wallet funding and receipts.</p>
