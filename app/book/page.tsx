    ...
    <Card className="p-4 sm:p-5">
      <div className="grid gap-5 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        <div>
          ...
          <h2 className="mt-4 text-3xl font-black leading-tight text-fleet-night sm:text-5xl">FastFleet is preparing operations in {state}</h2>
          <p className="mt-3 max-w-2xl text-sm font-semibold leading-7 text-slate-600">
            Your account is ready, but live deliveries open when FastFleet activates the {rolloutWaveForState(state, status)} for your area.
          </p>
