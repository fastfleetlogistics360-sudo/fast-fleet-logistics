...
export const metadata: Metadata = {
  ...
  description: "FAST FLEETS360 Logistics NDPR compliance statement for Nigerian data protection expectations."
};
...
export default function NdprPage() {
  return (
    <section className="section-wrap py-10">
      ...
      <h1 className="mt-3 max-w-3xl text-4xl font-black leading-tight text-fleet-night sm:text-6xl">FAST FLEETS360 data protection statement.</h1>
      <div className="mt-8 grid gap-5 text-sm font-semibold leading-7 text-slate-600">
        <p>FAST FLEETS360 is designed around Nigerian data protection expectations, including transparency, purpose limitation, security, data minimization, and user rights.</p>
