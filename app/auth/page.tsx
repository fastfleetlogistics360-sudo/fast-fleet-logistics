...
export default function AuthPage() {
  return (
    ...
    <CinematicPageHero
      ...
      body="Sign in with the same premium Fast Fleets 360 identity system that powers bookings, payouts, onboarding, and tracking."
        ...
        <div className="grid min-h-[360px] gap-6 p-5 sm:p-8 lg:min-h-full lg:content-between">
          <div>
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-xl font-black tracking-[0.02em]">Fast Fleets 360</span>
            </div>
