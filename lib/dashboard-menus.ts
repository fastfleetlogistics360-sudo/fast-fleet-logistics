...
export const customerDashboardMenu: DashboardMenuSection[] = [
  {
    ...
    items: [
      ...
      { title: "Marketplace Listing", body: "Business-only listing application", href: "/marketplace/listing", icon: Store },
...
export const businessDashboardMenu: DashboardMenuSection[] = [
  {
    ...
    items: [
      ...
      { title: "Marketplace Listing", body: "Apply to list your mall or marketplace store", href: "/marketplace/listing", icon: Store },
